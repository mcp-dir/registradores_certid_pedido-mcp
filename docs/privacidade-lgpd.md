...
Registradores (ARISP) Certidão: Novo Pedido de Certidão Digital segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [registradores_certid_pedido@mcp.ai](mailto:registradores_certid_pedido@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
